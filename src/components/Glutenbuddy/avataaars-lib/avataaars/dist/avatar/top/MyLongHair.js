...
var MyLongHair = /** @class */ (function (_super) {
    __extends(MyLongHair, _super);
    function MyLongHair() {
    ...
    MyLongHair.prototype.render = function () {
    ...
    MyLongHair.optionValue = 'MyLongHair';
    return MyLongHair;
}(React.Component));
exports.default = MyLongHair;
